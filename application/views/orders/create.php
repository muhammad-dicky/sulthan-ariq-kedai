        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-12 control-label">Time: <?php ini_set('date.timezone', 'Asia/Jakarta'); echo date('h:i a') ?></label>
                </div>
                ...
                <table class="table table-bordered table-hover" id="product_info_table">
                  <thead>
                    <tr>
                      ...
                      type="button" id="add_row" class="btn btn-info"><i class="fa fa-plus"></i></button></th>
                    </tr>
                  </thead>
